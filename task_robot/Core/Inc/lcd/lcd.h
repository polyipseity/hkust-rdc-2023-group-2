                                       ...
                                       uint8_t y)
{
    ...
    return ((buf->text_buf[buf->curr_screen][idx] != buf->text_buf[!buf->curr_screen][idx]) || (buf->text_color_buf[buf->curr_screen][idx] != buf->text_color_buf[!buf->curr_screen][idx]) || (buf->bg_color_buf[buf->curr_screen][idx] != buf->bg_color_buf[!buf->curr_screen][idx]));
}
