...
public:
     ...
     * @param convergence control reactiveness
     */
    AutoRobotADRC(decltype(m_position) position, double rotation, decltype(m_velocities) velocities, decltype(m_gain) gain = .2136283 / 2., double convergence = 1.) noexcept;
