##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.1.0] date: [Tue Oct 31 18:05:17 HKT 2023] 
##########################################################################################################################
...
$(BUILD_DIR)/%.o: %.cpp Makefile | $(BUILD_DIR) 
	$(CX) -c $(CPPFLAGS) -Wa,-a,-ad,-alms=$(BUILD_DIR)/$(notdir $(<:.c=.lst)) $< -o $@
